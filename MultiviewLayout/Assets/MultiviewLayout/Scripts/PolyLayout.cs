...
namespace MultiViewLayout
{
    public class PolyLayout : MultiviewLayout
    {
        ...
        public override void Register(View v)
        {
            base.Register(v);
        }

        public override void Remove(View v)
        {
            base.Remove(v);
            focusedViewA.Remove(v);
        }
        ...
        protected float GetYPosition(View v)
        {
            ...
            {
                return H - ((H * GetMaxAInLevel(v.Level) * 0.5f) + h);
            }
            else
            {
                return H - ((H * v.A * 0.5f) + h);
            }
        }
